...
# claude_code.sh {
	TMUX_POWERLINE_SEG_CLAUDE_CODE_SHOW_COST="yes"
	TMUX_POWERLINE_SEG_CLAUDE_CODE_CCUSAGE_CMD="nix run github:ryoppippi/ccusage/v20.0.6 --"
	TMUX_POWERLINE_SEG_CLAUDE_CODE_COST_MODE="both"
	TMUX_POWERLINE_SEG_CLAUDE_CODE_SHOW_SESSION_TIME="yes"
	TMUX_POWERLINE_SEG_CLAUDE_CODE_SHOW_WEEKLY_TIME="yes"
	TMUX_POWERLINE_SEG_CLAUDE_CODE_SHOW_CYCLE_TIME="yes"
# }
