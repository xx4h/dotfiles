...
export TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=$MY_TMUX_POWERLINE_LEFT_STATUS_SEGMENTS
export TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=$MY_TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS
...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="xx4h-slim"
...
# air.sh {
	...
	TMUX_POWERLINE_SEG_AIR_LAT="$MY_TMUX_POWERLINE_SEG_WEATHER_LAT"
	TMUX_POWERLINE_SEG_AIR_LON="$MY_TMUX_POWERLINE_SEG_WEATHER_LON"
	# Your Open Weather API Key:
	TMUX_POWERLINE_SEG_AIR_OPEN_WEATHER_API_KEY="$MY_TMUX_POWERLINE_SEG_AIR_OPEN_WEATHER_API_KEY"
# }
...
# claude_code.sh {
	export TMUX_POWERLINE_SEG_CLAUDE_CODE_COST_UPDATE_INTERVAL=600
	export TMUX_POWERLINE_SEG_CLAUDE_CODE_SHOW_COST="yes"
	export TMUX_POWERLINE_SEG_CLAUDE_CODE_COST_MODE="both"
	export TMUX_POWERLINE_SEG_CLAUDE_CODE_SHOW_SESSION_TIME="yes"
	export TMUX_POWERLINE_SEG_CLAUDE_CODE_SHOW_WEEKLY_TIME="yes"
	export TMUX_POWERLINE_SEG_CLAUDE_CODE_SHOW_CYCLE_TIME="yes"
# }
...
# github_notify.sh {
	...
	export TMUX_POWERLINE_SEG_GITHUB_NOTIFICATIONS_TOKEN="$MY_TMUX_POWERLINE_SEG_GITHUB_NOTIFICATIONS_TOKEN"
	...
	# export TMUX_POWERLINE_SEG_GITHUB_NOTIFICATIONS_REASONS=("approval_requested:areq" "assign:as" "author:au" "comment:co" "ci_activity:ci" "invitation:in" "manual:ma" "mention:me" "review_requested:rreq" "security_alert:sec" "state_change:st" "subscribed:sub" "team_mention:t")
...
# tmux_mem_cpu_load.sh {
	...
	# export TMUX_POWERLINE_SEG_TMUX_MEM_CPU_LOAD_ARGS="-v -a 1"
# }
