...
TMUX_POWERLINE_THEME_ACTIVE_STATUS_BACKGROUND_COLOUR="${TMUX_POWERLINE_THEME_ACTIVE_STATUS_BACKGROUND_COLOUR:-colour78}"
...
TMUX_POWERLINE_ACTIVITY_BACKGROUND_COLOR=${TMUX_POWERLINE_ACTIVITY_BACKGROUND_COLOR:-colour250}
